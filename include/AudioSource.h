...
public:
	...
	// Reproduce el sonido que tiene en loop o no seg�n el par�metro
	void playSound2D(bool loop = false);

	/// <summary>
	/// A�ade un sonido/musica y lo ejcuta en una posicion en concreto determinada por el parametro position, name es la direccion o nombre del archivo, 
	/// volume el volumen de dicho sonido y loop por si se quiere ejecutar en bucle
	/// </summary>
